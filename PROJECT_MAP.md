...
- Final full workspace, admin, Flutter, migration/recovery, deterministic demo, production-like, artifact-scan, and exact-head CI evidence is required before PR #6 can leave draft. PR #6 remains unmerged. M7C and M7D remain out of scope.

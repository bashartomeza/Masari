...
- The backend now has provider-neutral geocode and route contracts, fixed-host Mapbox/Google/HERE/Stadia adapters, a deterministic fake, normalized failures, bounded retry, an in-memory draft-preview cache, a provider circuit breaker, SHA-256 input/geometry integrity, and a fail-closed kill switch. No provider SDK or new dependency was added.
